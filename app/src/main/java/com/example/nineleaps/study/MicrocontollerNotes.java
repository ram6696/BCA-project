...
public class MicrocontollerNotes extends AppCompatActivity {
    String item[] = new String[]{"Module1", "Module2", "Module3","Module4","Module5","Module6"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_microcontoller_notes);
